...
<head>
    ...
    <style>
        ...
        #container {
            ...
            margin-left: 200px; /* Adjust the margin to leave space for the navbar */
...
<div id="navbar">
    ...
    <div id="container">
        ...
        <div id="input-container">
            <label for="user-input">Type all Alphabet for check WPM:</label>
    ...
    <script>
        ...
        function startGame() {
            document.getElementById('game-container').textContent = generateAlphabetString();
